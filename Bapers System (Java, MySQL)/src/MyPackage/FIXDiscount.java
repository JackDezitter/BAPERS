...
import pers.beans.FixedDiscount;
 ...
 * @author Amirk
 */
public class FIXDiscount extends javax.swing.JFrame {
    int customerID;
    /**
     * Creates new form Home
     */
    public FIXDiscount(int customerID) {
    ...
    private void initComponents() {
        ...
        ChangesTitle.setText("Fixed Discount");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ApplyBttn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
    ...
    private void ApplyBttnActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {//GEN-FIRST:event_ApplyBttnActionPerformed
        ...
        FixedDiscount discount = new FixedDiscount(customerID, amount);
        this.dispose();
        new ManageCustomers().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FIXDiscount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FIXDiscount(customerID).setVisible(true);
            }
        });
