...
import pers.beans.VariableDiscount;
 ...
 * @author Amirk
 */
public class VDiscount extends javax.swing.JFrame {
    int customerID;
    /**
     * Creates new form Home
     */
    public VDiscount(int customerID) {
    ...
    private void initComponents() {
        ...
        ChangesTitle.setText("Variable Discount");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(54, 54, 54)
                                .addComponent(ApplyBttn, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void ApplyBttnActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {//GEN-FIRST:event_ApplyBttnActionPerformed
        // TODO add your handling code here:
        int task = Integer.parseInt(Task.getText());
        float amount = Float.parseFloat(Amount.getText());
        VariableDiscount discount = new VariableDiscount(customerID, task, amount);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VDiscount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
