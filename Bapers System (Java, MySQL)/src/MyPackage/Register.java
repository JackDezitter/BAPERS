...
public class Register extends javax.swing.JFrame {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(RegisterTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void RegCompleteBttnActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here: Condition for logging in on register here
        List<String> errors;
        String msg="";
        CommonUtils commonUtils = new CommonUtils();
        // read data from the text boxes and add it to staffInfoBean object for validation
        StaffDBOperations dbOperations = new StaffDBOperations();
        StaffInfoBean staffInfoBean = new StaffInfoBean();
        staffInfoBean.setFirstName(Name.getText());
        staffInfoBean.setLastName(Surname.getText());
        staffInfoBean.setPassword(new String(this.Password.getPassword()));
        staffInfoBean.setAddress(Address.getText());
        staffInfoBean.setUserRole(String.valueOf(Role.getText()));
        staffInfoBean.setPhone(Phone.getText());
        staffInfoBean.setEmail(Email.getText());
        // if data entered is not validated show error using show error dialogue box
        errors  = commonUtils.validateMemberData(staffInfoBean);
        if(!errors.isEmpty()){
            msg = errors.stream().map(message -> message+"\n\r").reduce(msg, String::concat);
            JOptionPane.showMessageDialog(this, msg);
        }
        // if data is validated create new staff member by adding his detail to database
        // using function of StaffDBOPeration class
        else{
            Long bookingId = dbOperations.saveStaffMember(staffInfoBean, 1);
            if(bookingId>0){
                JOptionPane.showMessageDialog(this, "Member added Successfully.");
                ManageStaff In=new ManageStaff();
                In.setVisible(true);
                this.dispose();
            }else{
                JOptionPane.showMessageDialog(this, "Unable to add new Member");
            }
        }
    }
