...
public class Tasks2 extends javax.swing.JFrame {
    ...
    private void fillPageData(){
        ...
        List<Task> list = dBOperations.getTaskList("", new ArrayList<>());
        ...
        for(int i=0;i<list.size();i++){
            ...
            obj[0]= bean.getTaskID();
            obj[1]= bean.getLocation();
            obj[2]= bean.getDescription();
            obj[3]= bean.getPrice();
            obj[4] = bean.getDuration();
            data[i] = obj;
        }

        DefaultTableModel tableModel =  new DefaultTableModel(data,
                new String[]{"TaskID", "Location", "Description", "Price", "Duration"});
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(addTask, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tasks2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
